...
\vskip1ex
O exemplo nas páginas seguintes demonstra uma sequência de estados em uma fase principal e as ações legais correspondentes. Para estes exemplos iremos supor que o oponente do agente não tem nenhuma carta em sua mão, campo de batalha ou cemitério, e tem 10 pontos de vida.
