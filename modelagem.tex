...
Como descrito no capítulo \ref{chap:impl}, o agente de Mulligan é representado por uma classe herdada de \texttt{Player}.
...
possibilidades. Tomando alguma Fase Principal como escopo, podemos definir uma recompensa para qualquer
estado final (que sempre será após a ação \textit{Pass}).
\vskip1ex
